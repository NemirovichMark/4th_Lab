...
namespace Lesson
{
    class Program
    {
        public static void Main(string[] args)
        {
            ...
            ////LVL1, TSK 29
            //int[,] a = new int[5, 7] { { 4, 2, 3, 1, 5, 0, 29 }, { 12, 2, 0, 10, 11, 7, 6 }, { 20, 8, 228, 17, 12, 11, 29 }, { 21, 22, 23, 22, 25, 29, 23 }, { 24, 23, 11, 41, 21, 22, 12 } };
            //int n = 5;
            //int m = 7;
            //int amin = a[2, 0];
            //int jmin = 0;
            ...
            //}
            //int sortindex = 1;
            //while (sortindex < n.Length)
            //{
            //    if (sortindex == 0 || n[sortindex] <= n[sortindex - 1])
            //    {
            //        sortindex++;
            //    }
            //    else
            //    {
            //        int smena = n[sortindex - 1];
            //        n[sortindex - 1] = n[sortindex];
            //        n[sortindex] = smena;
            //        for (int j = 0; j < 5; j++)
            //        {
            //            smena = a[sortindex - 1, j];
            //            a[sortindex - 1, j] = a[sortindex, j];
            //            a[sortindex, j] = smena;
            //        }
            //        sortindex--;
            //    }
            ...
            while (k1 < elements.Length)
            {
                if (k1 == 0 || elements[k1 - 1] >= elements[k1])
                {
                    k1++;
                }
                else
                {
                    int replaceee = elements[k1];
                    elements[k1] = elements[k1 - 1];
                    elements[k1 - 1] = replaceee;
                    for (int j = 0; j < a.GetLength(1); j++)
                    {
                        replaceee = a[k1 - 1, j];
                        a[k1 - 1, j] = a[k1, j];
